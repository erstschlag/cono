...
public class UserService {
    ...
    public UserDto getOrCreateUser(String userId, String userName, String displayName) {
        UserDto user = mapstructMapper.userEntityToUserDto(retrieveOrCreateUser(userId, userName));
